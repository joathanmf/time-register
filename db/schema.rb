...
ActiveRecord::Schema[7.2].define(version: 2025_10_04_215029) do
  ...
  create_table "clockings", force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_clockings_on_user_id"
  end
  ...
  create_table "report_processes", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["process_id"], name: "index_report_processes_on_process_id", unique: true
  ...
  add_foreign_key "clockings", "users"
